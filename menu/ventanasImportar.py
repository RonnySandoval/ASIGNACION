...
class VentanaImportarDatos():
    ...
    def __init__(self, nombreVentana, bbdd):
        ...
        self.labelTitulo = ctk.CTkLabel(self.frameTitulo, text=f"IMPORTAR {self.nombreVentana} DESDE EXCEL", font=textoGrande)
        self.labelTitulo.pack(expand=True, side="top", fill="x", padx=20, pady=5)

        self.varEncabezadoFila = tk.StringVar() 
        self.labelEncabezadoFila = ctk.CTkLabel(self.frameEntradas, text="Fila de Encabezados", font=texto1Medio,  anchor="w")
        self.labelEncabezadoFila.grid(row=1, column=0, sticky="ew", padx=20, pady=5)
        self.OptionEncabezadoFila = ctk.CTkOptionMenu(self.frameEntradas, font = numerosMedianos, fg_color= grisAzuladoClaro, width=20, variable=self.varEncabezadoFila)
