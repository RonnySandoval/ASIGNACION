...
class ContenidoModelos():
    ...
    def llenar_contenido(self, bbdd):
        ...
        self.button_CrearModelo = ctk.CTkButton(master=self.frameModelosInterior,text="Crear Modelo", font=textoBajo,
                                                ...
                                                border_width=1,width=40, corner_radius=10,
                                                command= lambda:controller.crear_modelo(bbdd))
        self.button_CrearModelo.grid(row=0, column=7, padx=3, pady=5)
        
        #####################################################
        ############ Botones de EDITAR modelo ###############
        #####################################################
        for filasCambiarMod in range (1, BDqueries_before.calcula_modelos(bbdd)+1):
            ...
            glo.btt_editModelos[button_name] = ctk.CTkButton(master=self.frameModelosInterior,text="Editar", font=textoBajo,
                                                            ...
                                                            command=lambda varBoton=button_name:controller.editar_modelo(varBoton, bbdd))
        ...
        for filasModelos, textos in zip(range(1, BDqueries_before.calcula_modelos(bbdd)+1), BDqueries_before.leer_modelos(bbdd)):                 
        ...
        dfTiempos = BDqueries_before.leer_tiempos_modelos_df(bbdd)
        print(dfTiempos)
        ...
        cantidadModelos = BDqueries_before.calcula_modelos(bbdd)
        ...
        for filasAgregarVH in range (1, BDqueries_before.calcula_modelos(bbdd)+1):
