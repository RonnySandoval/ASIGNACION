...
ALTIMA = Mod_programador.VehiculoBase('ALTIMA', 'NISSAN')
FRONTIER = Mod_programador.VehiculoBase('FRONTIER', 'NISSAN')
KICKS = Mod_programador.VehiculoBase('KICKS', 'NISSAN')
QASHQAI = Mod_programador.VehiculoBase('QASHQAI', 'NISSAN')
LEAFT = Mod_programador.VehiculoBase('LEAFT', 'NISSAN')
VERSA = Mod_programador.VehiculoBase('VERSA', 'NISSAN')
PATHFINDER = Mod_programador.VehiculoBase('PATHFINDER', 'NISSAN')
XTRAIL = Mod_programador.VehiculoBase('XTRAIL', 'NISSAN')
CAPTUR = Mod_programador.VehiculoBase('CAPTUR', 'RENAULT')
KOLEOS = Mod_programador.VehiculoBase('KOLEOS', 'RENAULT')
KWID = Mod_programador.VehiculoBase('KWID' ,'RENAULT')
BJ20 = Mod_programador.VehiculoBase('BJ20', 'BAIC')
BJ40 = Mod_programador.VehiculoBase('BJ40', 'BAIC')
D50 = Mod_programador.VehiculoBase('D50', 'BAIC')
NX55 = Mod_programador.VehiculoBase('NX55', 'BAIC')
X35 = Mod_programador.VehiculoBase('X35', 'BAIC')
X55 = Mod_programador.VehiculoBase('X55', 'BAICBAIC')
U5P = Mod_programador.VehiculoBase('U5P', 'BAIC')
AUMARK = Mod_programador.VehiculoBase('AUMARK', 'FOTON')
AUMAN = Mod_programador.VehiculoBase('AUMAN', 'FOTON')
TUNLAND = Mod_programador.VehiculoBase('TUNLAND', 'FOTON')
VIEW = Mod_programador.VehiculoBase('VIEW', 'FOTON')
TOANO = Mod_programador.VehiculoBase('TOANO', 'FOTON')
AZKARRA = Mod_programador.VehiculoBase('AZKARRA', 'GEELY')
COOLRAY = Mod_programador.VehiculoBase('COOLRAY', 'GEELY')
RX8 = Mod_programador.VehiculoBase('RX8','MG')
RX5 = Mod_programador.VehiculoBase('RX5','MG')
MG5 = Mod_programador.VehiculoBase('MG5','MG')
ZS = Mod_programador.VehiculoBase('ZS','MG')
ONE = Mod_programador.VehiculoBase('ONE','MG')
...
for tecnico in lista_tecnicos:
    lista_objetos_tecnicos.append(Mod_programador.Tecnico(tecnico[0],tecnico[1],tecnico[2]))
...
for vehiculo in lista_vehiculos:
    lista_objetos_vehiculos.append(Mod_programador.Vehiculo(id_chasis = vehiculo[0],
                             fecha  = vehiculo[1],
                             marca  = vehiculo[2],
                             modelo = vehiculo[3],
                             color  = vehiculo[4],
...
"""
#EJEMPLO DE PEDIDO
pedido_quito06 = Mod_programador.Pedido(
                        id_pedido='p_qui06',
                        plazo_entrega = 5000,
