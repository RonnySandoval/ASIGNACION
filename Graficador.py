...
#######GANTT DE VEHICULOS#########
def generar_gantt_vehiculos(pedido, horizonte_calculado):
    ...
    funcionesGANTT.crear_gantt_vehiculos("GRAFICO_DE_VEHICULOS_01",lista_vehiculos, horizonte_calculado)
    ...
    for tarea in pedido.vehiculos:
        ...
        for proceso in tarea.historico_estados:         #busca los parámetros de entrada para cada tarea del grafico
            ...
            if duracion == 0:                           #evalua si la tarea no ocupa tiempo
                ...
                funcionesGANTT.agregar_proceso("GRAFICO_DE_VEHICULOS_01",inicio, duracion, tarea.id_chasis, nombre_proceso, encargado)
                print(f"Se agregó {nombre_proceso} en {tarea.id_chasis}")
        
    funcionesGANTT.mostrar_grafico_vehiculos("GRAFICO_DE_VEHICULOS_01")



#######GANTT DE TECNICOS#########
def generar_gantt_tecnicos(personal, horizonte_calculado):
    lista_personas =[]
    print(personal)
    ...
    #generación de gráfico con etiquetas de ejes
    funcionesGANTT.crear_gantt_tecnicos("GRAFICO_DE_TECNICOS_02", lista_personas, horizonte_calculado)
    ...
    for tarea in personal:
        ...
        for vehiculo in tarea.historico_asignacion:         #busca los parámetros de entrada para cada tarea del grafico
            ...
            if duracion == 0:                               #evalua si la tarea no ocupa tiempo
                ...
                funcionesGANTT.agregar_vehiculo("GRAFICO_DE_TECNICOS_02",inicio, duracion, tarea.id_tecnico, id_vehiculo)
